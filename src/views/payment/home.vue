...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const saleOptions = ref<SelectOption[]>([])
          ...
          [
            {
              ...
              render: (formItem) => {
                return h(NInput, {
                  ...
                  maxlength: 50,
                  placeholder: 'Please enter the source type',
                })
              },
              validator: (formItem, message) => {
                if (!formItem.value.value) {
                  message.error('Please enter the source type')
                  return false
                }
                return true
              },
            },
            {
              ...
              type: 'select',
              value: ref(null),
              optionItems: enrollmentOptions.value,
              render: (formItem) => {
                return h(NSelect, {
                  value: formItem.value.value,
                  onUpdateValue: (newVal) => {
              ...
              validator: (formItem, message) => {
                if (!formItem.value.value) {
                  message.error('Please select enrollment')
                  return false
                }
                return true
              },
            },
            {
              ...
              render: (formItem) => {
                return h(NSelect, {
                  ...
                  placeholder: 'Please select sale',
                  clearable: true,
                  options: formItem.optionItems as SelectOption[],
                })
              },
              validator: (formItem, message) => {
                if (!formItem.value.value) {
                  message.error('Please select sale')
                  return false
                }
                return true
              },
            },
            {
              ...
              validator: (formItem, message) => {
                if (!formItem.value.value) {
                  message.error('Please enter the paid amount')
                  return false
                }
                return true
              },
        ...
        try {
          ...
          if (success) {
            ...
            const url =
              title.value === FormAction.ADD
                ? PAYMENT.CREATE
                : `${PAYMENT.UPDATE}/${selectedId.value}`
