        ...
        () =>
          [
            ...
            },
            {
              ...
              type: 'select',
              value: ref(null),
              optionItems: studentOptions.value,
              render: (formItem) => {
                return h(NSelect, {
                  value: formItem.value.value,
                  onUpdateValue: (newVal) => {
            ...
            },
            {
              ...
              render: (formItem) => {
                return h(NDatePicker, {
                  value: formItem.value.value,
                  placeholder: 'Please enter the sale date',
                  style: 'width: 100%',
                  onUpdateValue: (val) => {
                    formItem.value.value = val
                  },
              ...
              validator: (formItem, message) => {
                if (!formItem.value.value) {
                  message.error('Please enter the sale date')
                  return false
                }
                return true
              },
            },
            {
              ...
              render: (formItem) => {
                return h(NInput, {
                  ...
                  maxlength: 50,
                  placeholder: 'Please enter the total paid',
                })
              },
              validator: (formItem, message) => {
                if (!formItem.value.value) {
                  message.error('Please enter the total paid')
                  return false
                }
                return true
              },
            ...
            },
            {
              ...
              validator: (formItem, message) => {
                if (!formItem.value.value) {
                  message.error('Please enter the discount percentage')
                  return false
                }
                return true
              },
      ...
      function onDataFormConfirm(loading: Ref<boolean>) {
        try {
          ...
          if (success) {
            ...
            const url =
              title.value === FormAction.ADD ? SALE.CREATE : `${SALE.CANCEL}/${selectedId.value}`
