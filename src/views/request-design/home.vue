...
<script lang="ts">
  ...
  import { Category, RequestDesign } from '@/api/url'
      ...
      const tableColumns = useTableColumn(
        [
          ...
          table.indexColumn,
          {
            title: 'Requester',
            key: 'user',
            render: (rowData) => h('div', rowData.user?.fullName),
          },
          {
            title: 'Sample Images',
            key: 'sampleImages',
          ...
          },
          {
            ...
            render: (rowData) =>
              h(
                ...
                {
                  onClick: () => {
                    window.open(`https://t.me/${rowData.contact}`)
                  },
                },
                rowData.contact
              ),
